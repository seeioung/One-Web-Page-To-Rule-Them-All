...
// positon indicator
function position_indicator(event) {
    let nav_bar = document.getElementsByClassName("navbar")[0];
...
model_div_1.addEventListener('click', function(event) {
    close_model(1);
});

let model_div_2 = document.getElementById("model2-div");
model_div_2.addEventListener('click', function(event) {
    close_model(2);
});

let model_div_3 = document.getElementById("model3-div");
model_div_3.addEventListener('click', function(event) {
    close_model(3);
});


let album_img_1 = document.getElementById("album-img-1");
album_img_1.addEventListener('click', function(event) {
    open_model(1);
});

let album_img_2 = document.getElementById("album-img-2");
album_img_2.addEventListener('click', function(event) {
    open_model(2);
});

let album_img_3 = document.getElementById("album-img-3");
album_img_3.addEventListener('click', function(event) {
    open_model(3);
});
